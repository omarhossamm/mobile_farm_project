...
The script generates `MobileStreamDesktop.icns` from `Assets/generated/app-icon-source.png` and writes `Info.plist` with `CFBundleIconFile`, which is what Dock uses.
